...
garfield comic capturer in spanish
@author: Xarly

format web: http://www.gocomics.com/garfieldespanol%20/2007/06/01
...
check=True
capt=True
d1 = date(2006, 1, 1)  # start date y m d
d2 = date(2006, 1, 31)  # end date
...
p=B[3].split(" ")[4]
#p[5:-1] contains the taday's img link
